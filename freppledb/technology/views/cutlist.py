...
class ConnectionListList(GridReport):
    ...
    rows = (
        GridFieldText("from_tip__short_name", title=_("from_tip__short_name"), initially_hidden=True, ),
        GridFieldText("to_tip__short_name", title=_("to_tip__short_name"), initially_hidden=True, ),
        GridFieldText("from_seal__short_name", title=_("from_seal__short_name"), initially_hidden=True, ),
        GridFieldText("to_seal__short_name", title=_("to_seal__short_name"), initially_hidden=True, ),
        ...
        GridFieldHierarchicalText("operation", title=_("Операция"), field_name="operation__name", key=False, formatter="detail", extra='"role":"input/operation"', model=Operation, ),
        GridFieldHierarchicalText( "item", title=_("Провод"), field_name="item__short_name", key=False, formatter="detail", extra='"role":"technology/itemt"',model=ItemT, ),
        GridFieldText("wire_no", title=_('Имя жилы')),
        GridFieldInteger("quantity", title=_("Кол-во") ),
        GridFieldHierarchicalText( "from_tip", title=_("наконечник начала"), field_name="from_tip__image", key=False, formatter="image_from_tip", ),
        GridFieldHierarchicalText( "to_tip", title=_("наконечник конца"), field_name="to_tip__imagef", key=False, formatter="image_to_tip", ),
        GridFieldNumber("start_strip", title=_('Зачистка начало, мм')), #"Зачистка начало, мм"
        GridFieldBool("start_tinning", title=_("облудить начало"), formatter='checkbox'),
        GridFieldHierarchicalText("from_seal", title=_("уплотнитель начала"), field_name="from_seal__image", key=False, formatter="image_from_seal", ),
        GridFieldNumber("length", title=_("Длина, мм")),
        GridFieldHierarchicalText("to_seal", title=_("уплотнитель конца"), field_name="to_seal__imagef", key=False, formatter="image_to_seal", ),
        GridFieldText("from_connector", title=_("от разъёма"), ),
        GridFieldText("to_connector", title=_("к разъёму"), ),
        GridFieldText("sygnal", title=_("Имя цепи"), ),
        GridFieldBool("end_tinning", title=_("облудить конец"), formatter='checkbox'),
        GridFieldNumber("end_strip", title=_("Зачистка конец, мм")),
        GridFieldNumber("from_pin", title=_("от контакта")),
        GridFieldNumber("to_pin", title=_("к контакту")),
...
class ItemTList(GridReport):
    ...
    message_when_empty = Template(
        ...
        <br><br>
        <div role="group" class="btn-group.btn-group-justified">
        <a href="{{request.prefix}}/data/technology/itemt/add/" class="btn btn-primary">Create a single item<br>in a form</a>
    ...
    rows = (
        GridFieldHierarchicalText("name", title=_("name"), key=True, formatter="detail", extra='"role":"technology/itemt"', model=ItemT, ),
        ...
        GridFieldText("image", title=_("IM"), formatter="imagenew", key=False, ),
        ...
        GridFieldText("barcode__image", title=_("Barcode"), formatter="imagenew2", key=False, ),
        GridFieldText("owner", title=_("owner"), field_name="owner__name", formatter="detail", extra='"role":"technology/itemt"', ),
        ...
        GridFieldInteger("periodofcover", title=_("period of cover"), initially_hidden=True ),
        GridFieldChoice("type", title=_("type"), choices=ItemT.types, initially_hidden=True ),
...
class SolderingList(GridReport):
    ...
    rows = (
        ...
        GridFieldText("SP_pos", title=_("Поз.")),
        GridFieldHierarchicalText("operation", title=_("Операция"), field_name="operation__name", key=False, formatter="detail", extra='"role":"input/operation"', model=Operation, ),
        GridFieldHierarchicalText("item", title=_("Провод"), field_name="item__short_name", key=False, formatter="detail", extra='"role":"technology/itemt"', model=Item,),
        GridFieldText("wire_no", title=_("Имя жилы")),
        GridFieldInteger("quantity", title=_("Кол-во") ),
        GridFieldNumber("start_strip", title=_("Зачистка начало, мм")),
        GridFieldBool("start_tinning", title=_("облудить начало"), formatter='checkbox'),
