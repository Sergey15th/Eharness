...
class ConnectionListList(GridReport):
    ...
    rows = (
        ...
        GridFieldHierarchicalText( "from_tip", title=_("наконечник начала"), field_name="from_tip__image", key=False, formatter="imagenew", ),
        GridFieldHierarchicalText( "to_tip", title=_("наконечник конца"), field_name="to_tip__imagef", key=False, formatter="imagenew", ),
        ...
        GridFieldHierarchicalText("from_seal", title=_("уплотнитель начала"), field_name="from_seal__image", key=False, formatter="imagenew", ),
        GridFieldNumber("length", title=_("Длина, мм")),
        GridFieldHierarchicalText("to_seal", title=_("уплотнитель конца"), field_name="to_seal__imagef", key=False, formatter="imagenew", ),
